...
The homeassistant.components.modbus dependency provides the shared Modbus
connection; the WS90 register map itself comes from this integration's
vendored copy of the ecowitt-ws90-modbus device library (see vendor/), kept
free of any Home Assistant dependency so it can also be used standalone.
"""
